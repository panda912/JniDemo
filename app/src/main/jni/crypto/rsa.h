...
class rsa {
public:
    static string generatePublicKey(string base64EncodedKey);

    static string generatePrivateKey(string base64EncodedKey);

    static string encryptRSA(const string &publicKey, const string &from);

    static string decryptRSA(const string &privetaKey, const string &from);
};
